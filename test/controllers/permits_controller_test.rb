...
class PermitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permit" do
    assert_difference('Permit.count') do
      post permits_url, params: { permit: { address: @permit.address, city_permit_id: @permit.city_permit_id, location: @permit.location, notified_at: @permit.notified_at } }
    end
  ...
  test "should update permit" do
    patch permit_url(@permit), params: { permit: { address: @permit.address, city_permit_id: @permit.city_permit_id, location: @permit.location, notified_at: @permit.notified_at } }
